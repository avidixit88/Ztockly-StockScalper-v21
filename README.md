...
v7.4.8:
- Clean rebase of app.py.
- Adds **Send email alerts** toggle + deterministic **Capture test alert** that can email.
- Supports Streamlit Secrets in `[email]` table (smtp_user/smtp_password/to_email) or flat keys.
